...
wget https://raw.githubusercontent.com/nuntius-dev/Termux-XFCE/refs/heads/main/xfce.sh
wget https://raw.githubusercontent.com/nuntius-dev/Termux-XFCE/refs/heads/main/proot.sh
